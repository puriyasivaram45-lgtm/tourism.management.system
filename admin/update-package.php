...
<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="number" min="1" class="form-control1" name="packageprice" id="packageprice" placeholder="Package Price in INR" value="<?php echo htmlentities($result->PackagePrice);?>" required>
									</div>
								</div>
