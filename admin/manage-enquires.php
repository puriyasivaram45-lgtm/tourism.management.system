...
header('location:index.php');
	...
	// code for marking enquiries as read
...
{
	?><td>Read | 	
	<form method="post" onsubmit="return confirm('Do you really want to delete?')" style="display:inline;">
	<?php echo csrf_field(); ?>
	<input type="hidden" name="id" value="<?php echo e($result->id); ?>">
	<button type="submit" name="delete_enquiry" class="btn btn-link" style="padding:0;color:red;">Delete</button>
	</form>
	</td>
<?php } else {?>

<td>
	<form method="post" onsubmit="return confirm('Do you really want to read')" style="display:inline;">
	<?php echo csrf_field(); ?>
	<input type="hidden" name="eid" value="<?php echo e($result->id); ?>">
	<button type="submit" name="mark_read" class="btn btn-link" style="padding:0;">Pending</button>
	</form> | 
