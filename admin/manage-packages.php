...
<form method="post" onsubmit="return confirm('Do you really want to delete?')" style="margin:0;">
<?php echo csrf_field(); ?>
<input type="hidden" name="id" value="<?php echo e($result->PackageId); ?>">
<button type="submit" name="delete_package" class="btn btn-danger btn-block">Delete</button>
</form>
								</td>
						  </tr>
						 <?php $cnt=$cnt+1;} }?>
