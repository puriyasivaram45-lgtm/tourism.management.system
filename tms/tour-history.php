...
?></td>
	...
	<td>
	<?php $payment = payment_latest_for_booking($dbh, $result->bookid, $_SESSION['login']); ?>
	<?php if($payment) { ?>
		<?php echo e($payment->Status); ?><br>
		<a href="payment-status.php?booking=<?php echo e($result->bookid); ?>">View</a>
	<?php } elseif((int)$result->status !== 2) { ?>
		<a href="payment-start.php?booking=<?php echo e($result->bookid); ?>">Make Payment</a>
	<?php } else { ?>
		Not started
	<?php } ?>
	<br><a href="invoice.php?booking=<?php echo e($result->bookid); ?>">Invoice</a>
	</td>
	...
	<?php } else {?>
	<td>
	<form method="post" onsubmit="return confirm('Do you really want to cancel booking')" style="margin:0;">
	<?php echo csrf_field(); ?>
