...
try {
$pimage=save_package_image_upload($_FILES["packageimage"], __DIR__ . "/pacakgeimages");
if(!is_numeric($pprice) || (int)$pprice <= 0) {
throw new RuntimeException('Package price must be a positive number.');
}
...
<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="number" min="1" class="form-control1" name="packageprice" id="packageprice" placeholder="Package Price in INR" required>
									</div>
								</div>
